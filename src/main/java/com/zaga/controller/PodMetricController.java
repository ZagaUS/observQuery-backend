...
public class PodMetricController {
    ...
    // System.out.println("------------API call startTimestamp------ " +
    // APICallStart);

    // List<PodMetricsResponseData> podMetricsData =
    // podMetricsHandler.getAllPodMetricsByDate(
    // from,
    // to,
    // page,
    // pageSize,
    ...
    public Response getAllPodMetrics(
        ...
        // openshiftLoginHandler.commonClusterLogin(userName, clusterName);
        // // String nodeString = nodeName;
        // // // if (nodeName == null) {
        // // nodeString = "ClusterMethod";
        // // }
        // // Response response =
        // openshiftLoginHandler.viewClusterCapacity(openShiftClient);
        ...
        // JsonArray jsonArray =
        // jsonElement.getAsJsonObject().get("environments").getAsJsonArray();
        // System.out.println("---------jsonArr" + jsonArray);

        // String OPENSHIFTCLUSTERNAME = null;
        // for (JsonElement jsonElement2 : jsonArray) {
        // String dbClusterName =
        // jsonElement2.getAsJsonObject().get("clusterName").getAsString();
        // String openshiftClusterName =
        // jsonElement2.getAsJsonObject().get("openshiftClusterName").getAsString();
